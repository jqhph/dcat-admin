 ...
 * @method $this filling($filling, int $x = null, int $y = null)                                                                           Fill current image with given color or another image used as tile for filling. Pass optional x, y coordinates to start at a certain point.
...
class BootstrapImage extends BootstrapFile
{
     ...
     * {@inheritdoc}
     */
    protected $view = 'admin::form.bootstrapfile';
