...
class Orderable extends AbstractDisplayer
{
    ...
    public function display($order='asc')
    {
...
<div class="">
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$this->getKey()}" data-direction="{($order == 'asc' ? 1 : 0)}">
    ...
    <a href="javascript:void(0)" class=" font-14 {$this->grid->getRowName()}-orderable" data-id="{$this->getKey()}" data-direction="{($order == 'asc' ? 0 : 1)}">
