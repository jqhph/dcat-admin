...
<br>
<p align="center"><code>Dcat Admin</code>是一个基于<a href="https://www.laravel-admin.org/" target="_blank">laravel-admin</a>二次开发而成的后台构建工具，只需很少的代码即可快速构建出一个功能完善且颜值极高的后台系统。对后端开发者非常友好，内置丰富的后台常用组件，开箱即用，让开发者告别冗杂的HTML代码。</p>
